...
* 开发分支应标明版本号
* 功能分支格式feature/{JIRA号}_{负责人姓名}
* bug 修复分支格式hotfix/{JIRA号}_{负责人姓名}
* 因重构或改进的工作分支格式improve/{JIRA号}_{负责人姓名}
...
* 合并到开发分支的 feature 分支必须以JIRA号开头
* 开发分支rebase到master时的message要写CHANGELOG
* master合并开发分支或BUG修改分支时应使用git merge --no-ff
